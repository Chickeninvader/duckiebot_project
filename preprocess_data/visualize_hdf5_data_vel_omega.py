...
parser.add_argument("hdf5_path", type=str, nargs="?", default="converted_standard/all_demos_new.hdf5", help="Path to the HDF5 dataset.")
parser.add_argument("demo_number", type=int, nargs="?", default=1, help="Demo number to visualize (e.g., 1 for demo_1).")
...
for i in range(len(images)):
    ...
    # Overlay text with action values (updated for velocity and angle)
    text = f"Action: Vel {action[0]:.2f}, Angle {action[1]:.2f}"
